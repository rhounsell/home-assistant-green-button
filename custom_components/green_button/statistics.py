...
from . import _statistics_recorder, allocation, model, scaling
from ._statistics_recorder import (
    _async_replace_statistics,
...
class GreenButtonEntity(Protocol):
    """Protocol for Green Button entities that provide statistic metadata."""
...
async_cancel_statistics_tasks = _statistics_recorder.async_cancel_statistics_tasks
async_schedule_statistics_update = _statistics_recorder.async_schedule_statistics_update
clear_statistic = _statistics_recorder.clear_statistic
rename_external_statistic = _statistics_recorder.rename_external_statistic
